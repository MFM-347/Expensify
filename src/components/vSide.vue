<template>
  <div class="flex flex-col space-y-6">
    <section id="filter" class="bg-white dark:bg-zinc-800 rounded-xl p-6 shadow-md">
      <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-6">Filter Transactions</h3>
      <div class="flex flex-col space-y-4">
        <div class="flex justify-between gap-2 bg-gray-100 dark:bg-zinc-900 p-1 rounded-xl">
          <button
    ...
    <section id="add-transaction-form" class="bg-white dark:bg-zinc-800 rounded-xl p-6 shadow-md">
      <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-6">Add New Transaction</h3>
